...
- Канал R: ![](lab1/Output_R.png)
- Канал G: ![](lab1/Output_G.png)
- Канал B: ![](lab1/Output_B.png)

## 2. Преобразование изображения в HSI
Ниже представлены компоненты:
- Яркостная компонента: ![](lab1/Output_Intensity.png)
- Инвертированная яркостная компонента: ![](lab1/Output_Inverted_Intensity.png)
...
Результат растяжения: ![](lab1/Output_Stretched.png)  
Размер изображения: (3072, 3072)

### 3.3 Сжатие (децимация)
Коэффициент сжатия: N = 2  
Результат сжатия: ![](lab1/Output_Compressed.png)  
Размер изображения: (512, 512)

### 3.4 Передискретизация в два прохода (растяжение + сжатие)
Коэффициент: K = M / N = 1.5  
Результат передискретизации в два прохода: ![](lab1/Output_TwoPass_Resampled.png)  
Размер изображения: (1536, 1536)

### 3.5 Передискретизация в один проход
Коэффициент: K = 1.5  
Результат передискретизации в один проход: ![](lab1/Output_OnePass_Resampled.png)  
...
## 1. Исходные данные
Входное изображение: ![](lab2/image1.png)  

## 2. Приведение к полутоновому
Результат: ![](lab2/image1_gray.bmp)  
(Использовалось взвешенное усреднение R,G,B)

## 3. Адаптивная бинаризация (Феня и Тана, окно 3&times;3)
Коэффициент *k* = 0.2  
Результат бинаризации: ![](lab2/image1_binarized.bmp)

## 1. Исходные данные
Входное изображение: ![](lab2/image2.png)  

## 2. Приведение к полутоновому
Результат: ![](lab2/image2_gray.bmp)  
(Использовалось взвешенное усреднение R,G,B)

## 3. Адаптивная бинаризация (Феня и Тана, окно 3&times;3)
Коэффициент *k* = 0.2  
Результат бинаризации: ![](lab2/image2_binarized.bmp)

## 1. Исходные данные
Входное изображение: ![](lab2/image3.png)  

## 2. Приведение к полутоновому
Результат: ![](lab2/image3_gray.bmp)  
(Использовалось взвешенное усреднение R,G,B)

## 3. Адаптивная бинаризация (Феня и Тана, окно 3&times;3)
Коэффициент *k* = 0.2  
Результат бинаризации: ![](lab2/image3_binarized.bmp)
...
- Порог: 50
- Результат: ![](lab4/g_bin.jpg)

## 5. Морфологическая разность (дополнительно)
- Файл: ![](lab4/difference_morph.jpg)
...
![](lab5/profiles/armenian_1334_profile_x.png)  
![](lab5/profiles/armenian_1334_profile_y.png)
...
![Фраза](lab6/phrase.bmp)

## 2. Профили изображения
![Профиль X](lab6/profile_x.png)
![Профиль Y](lab6/profile_y.png)

## 3. Результат сегментации
![Сегментация](lab6/segments_outline.png)
...
![Исходное](lab8/results/original.jpg)  
**Рисунок 1.** Исходное изображение

![Преобразованное](lab8/results/transformed.jpg)  
**Рисунок 2.** Результат степенного преобразования (gamma=0.5)

## Карты локальных бинарных шаблонов (LBP)
![LBP исходное](lab8/results/lbp_original.jpg)  
**Рисунок 3.** LBP-карта исходного изображения

![LBP преобразованное](lab8/results/lbp_transformed.jpg)  
**Рисунок 4.** LBP-карта после преобразования

## Гистограммы яркости
![Гистограммы](lab8/results/histograms.png)  
**Рисунок 5.** Сравнение гистограмм яркости

## Гистограммы LBP
![LBP гистограммы](lab8/results/lbp_histograms.png)  
...
### Оригинальный сигнал
![Спектрограмма](lab9/original_spectrogram.png)
...
![График энергии](lab9/energy_analysis.png)
...
![Спектрограмма](lab10/А_spectrogram.png)
...
![Спектрограмма](lab10/И_spectrogram.png)
...
![Спектрограмма](lab10/гавканье_spectrogram.png)